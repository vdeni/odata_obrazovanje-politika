...
prezimena. Iz infleksijske baze ću zadržati samo unose koji imaju tag
`Npfsn` ili `Npmsn` jer, ako dobro tumačim bazu, te oznake stoje uz osobne
imenice u nominativu jednine, pri čemu `f` i `n` označavaju da je ime
